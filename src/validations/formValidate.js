function formValidate(formValues)
{
    ...
    if( firstNameFieldValidation(formValues.firstName) == true && 
    ...
    console.log(`Submitted by ${formValues.firstName} ${formValues.lastName} having Email ${formValues.email} and the message is ${formValues.message}`);
...
export function firstNameFieldValidation(firstNameValue)
{
    ...
    if(requiredValidation(firstNameField, "First Name", firstNameValue) == false){ return false; }

    if(lengthValidation(firstNameField, "First Name", firstNameValue, 2, 20) == false){ return false; }

    if(alphabetsValidation(firstNameField, "First Name", firstNameValue) == false){ return false; }
...
export function lastNameFieldValidation(lastNameValue)
{
    ...
    if(requiredValidation(lastNameField, "Last Name", lastNameValue) == false){ return false; }

    if(lengthValidation(lastNameField, "Last Name", lastNameValue, 2, 20) == false){ return false; }

    if(alphabetsValidation(lastNameField, "Last Name", lastNameValue) == false){ return false; }
...
export function emailFieldValidation(emailValue)
{
    ...
    if(requiredValidation(emailField, "Email Address", emailValue) == false){ return false; }

    if(emailValidation(emailField, "Email Address", emailValue) == false){ return false; }
...
export function messageFieldValidation(messageValue)
{
    ...
    if(requiredValidation(messageField, "Message", messageValue) == false){ return false; }

    if(lengthValidation(messageField, "Message", messageValue, 10, 160) == false){ return false; }
...
function lengthValidation(inputField, inputFieldName, inputFieldValue, minLength, maxLength)
{
