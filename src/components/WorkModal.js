            ...
            <Modal.Body>
                <Container>
                    <Row>
                        <Col lg={4}>
                            <Card className="p-0">
                                <span style={{backgroundImage: `url(${props.image})`}} className="m-0"></span>
                            </Card>
                        </Col>
                        ...
                        <Col lg={8} className="mt-4 mt-lg-0">
                            ...
                            <div className="buttons d-flex flex-wrap justify-content-evenly mt-xs-3">
                                <Button className="main-btn primary-btn mt-3 mt-xs-0" href={props.github} target="_blank">
                                    GitHub Link
                                </Button>

                                <Button className="main-btn primary-btn mt-3 mt-xs-0" href={props.host} target="_blank">
                                    Official Link
                                </Button>
                            </div>
